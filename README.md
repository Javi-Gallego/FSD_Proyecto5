...
In the HTTP directory there is a file named social_network_local.json, you can open it with 'Thunder Client' to have all the endpoints of the API. For the endpoints examples below I will use the deployed url. In the social_network_local.json you have the url with your localhost.
...
In the HTTP directory theres a file named social_network_deployed.json, you can open it with 'Thunder Client' to have all the endpoints of the API.
</details>
...
## Future features
[ ] Comments have their own entitie and can be edited, liked, updated... In this approach its only an addition to posts
[ ] Possibility to upload files to make posts more appealing and to add a photo to your profile
